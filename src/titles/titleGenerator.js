...
function generateTitle(vlogDate) {
  ...
  const titles = [
    ...
    "before toronto woke up",
    "2008 again",
    "time machine plan",
    "the long way to the rivoli",
    "friends first",
    "band second",
    ...
    "the next big thing",
    "no one saw us",
    "the greatest mistake yet",
    "we're committed now",
    "close enough to genius",
    ...
    "worth the risk",
    "the plan is working",
    "for godsake my name is your arch nemisis",
    "scarsbourgh bluffs",
    "let us cook",
    "the city had other plans",
    "one last favor",
    "everything but the concert",
    "this is important",
    "it's a long story",
    "we'll explain later",
    "the impossible afternoon",
